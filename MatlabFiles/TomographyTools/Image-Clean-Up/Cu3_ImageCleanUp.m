function Cu3_ImageCleanUp(start, finish)
% Cu3_ImageCleanUp - 
%   
%   USAGE:
%
%   Cu3_ImageCleanUp(start, finish)
%
%   INPUT:
%
%   start is numeric,
...
%
    ...
    load_prefix = '/home/abartolo/Work/Cu3-Tomography/Reconstructions/recon_layer_';
    load_suffix = '.bin';
    write_prefix = '/home/abartolo/Work/Cu3-Tomography/CleanUp/recon_layer_';
    write_suffix = '.bin';
    if( start < 872 )
        start = 872;
    end
