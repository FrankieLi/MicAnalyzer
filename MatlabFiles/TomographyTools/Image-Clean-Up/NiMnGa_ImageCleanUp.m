function NiMnGa_ImageCleanUp(start, finish)
% NiMnGa_ImageCleanUp - 
%   
%   USAGE:
%
%   NiMnGa_ImageCleanUp(start, finish)
%
%   INPUT:
%
%   start is numeric,
...
%       done by calling the NiMnGa_ReconAlgorithm.m .
%
    load_prefix = '/home/abartolo/Work/NiMnGa-Tomography/Reconstructions/recon_layer_';
    load_suffix = '.bin';
    write_prefix = '/home/abartolo/Work/NiMnGa-Tomography/CleanUp/recon_layer_';
    write_suffix = '.bin';
    if( start < 532 )
        start = 532;
    end
    ...
    parfor i=start:finish
        ...
        processedLayer3 = NiMnGa_ReconAlgorithm(layer1, layer2, layer3, layer4, layer5);
