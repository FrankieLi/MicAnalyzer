...
%%Updates: October 17, 2007 - refinements made to removal of outliers
...
material = 2; % material = 1 for ruby, material = 0 for gold, material = 2 for silicon.  Needed in indexing
...
[X_int, Y_int] =  PlaneLineIntersection_xy_Monitor(AllLines_Final, Spots, Zfit_Final, L1);
Plot_Info = [X_int', Y_int', AllLines_Final(:,4)];
figure(10)
scatter(Plot_Info(:,1), Plot_Info(:,2), 30, Plot_Info(:,3));
...
TwoThetaList = textread('Si_2thetas.txt');
