function Cu5_ImageCleanUp(start, finish)
% Cu5_ImageCleanUp - 
%   
%   USAGE:
%
%   Cu5_ImageCleanUp(start, finish)
%
%   INPUT:
%
%   start is numeric,
...
%
    load_prefix = '/home/abartolo/Work/Cu5-Tomography/Reconstructions/recon_layer_';
    load_suffix = '.bin';
    write_prefix = '/home/abartolo/Work/Cu5-Tomography/CleanUp/recon_layer_';
    write_suffix = '.bin';
    if( start < 822 )
        start = 822;
    end
